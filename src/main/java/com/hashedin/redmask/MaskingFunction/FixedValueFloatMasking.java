...
public class FixedValueFloatMasking extends ColumnRule {
  @Override
  ...
  public String getSubQuery(MaskConfiguration config, String tableName) throws IOException, TemplateException {
    ...
    paramsList.add("4.0");
    return QueryBuilderUtil.processQueryTemplate(config, MaskingConstants.MASK_FLOAT_FIXED_VALUE_FUNC,paramsList);
  }
}
